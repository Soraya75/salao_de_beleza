document.addEventListener('DOMContentLoaded', function () {
    ...
    function enviarFormulario(form, formspreeURL) {
        ...
        const data = {}; // Converter os dados do FormData para um objeto
    ...
    if (contatoForm) {
        const formspreeURLContato = 'https://formspree.io/f/xzzbelje'; // URL para o Formspree de contato
    ...
    if (orcamentoForm) {
        const formspreeURLContato = 'https://formspree.io/f/xdkoerjv'; // URL para o Formspree de contato

        orcamentoForm.addEventListener('submit', function (event) {
            event.preventDefault();
            enviarFormulario(orcamentoForm, formspreeURLContato);
        });
    }
});
